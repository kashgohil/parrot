	...
	return (
		<>
			...
			<p>
				...
				have the same issue. The model doesn't know that "Supabase" is a word, so it
				transcribes what sounds closest in its training data.
			</p>

			<h2>How custom vocabulary works</h2>
			<p>
				Custom vocabulary gives the transcription engine a hint: "these specific terms are
				likely to appear in this audio." When the model is deciding between "Cooper Netties"
				and "Kubernetes," the vocabulary list tips the scale toward the correct transcription.
			</p>
			<p>
			...
			<p>
				...
				better than dumping in hundreds of words. A targeted list of 50–100 terms covers
				most people's needs.
			</p>
			...
			<p>
				For example, you might say: "send the proposal to Priya Raghavan at Anthropic and
				CC the YC partners, um, make sure to mention the Series A timeline." With vocabulary
				and cleanup, the output is:
			</p>
			<p>
				<em>"Send the proposal to Priya Raghavan at Anthropic and CC the YC partners. Make
				sure to mention the Series A timeline."</em>
			</p>
			<p>
