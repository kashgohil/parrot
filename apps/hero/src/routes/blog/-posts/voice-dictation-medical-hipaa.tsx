	...
	return (
		<>
			...
			<p>
				...
				<strong> Business Associate Agreement (BAA)</strong> with the provider. Some providers
				offer BAAs (OpenAI does for enterprise accounts), but many don't. And even with a BAA,
				you're trusting a third party with patient data.
			</p>

			<h2>Local mode: the simplest solution</h2>
			<p>
				The cleanest way to handle PHI in voice dictation is to keep everything on-device.
			...
			<p>
				This doesn't mean you can ignore all HIPAA requirements. You still need appropriate
				device security (FileVault encryption, strong passwords, auto-lock), and your
				organization's policies around dictation software still apply. But you've eliminated
				the biggest risk: data in transit.
			</p>

			<h2>Custom vocabulary for medical terminology</h2>
			<p>
				Medical dictation has a specific challenge: terminology. Drug names, procedures,
				anatomical terms, and abbreviations that general-purpose transcription engines
			...
			<ul>
				...
				<li>Dictate the patient note conversationally: "Patient is a 54-year-old male presenting with chest pain radiating to the left arm. BP 150 over 95. History of hypertension."</li>
				<li>The AI cleanup formats it into clean clinical text, removing filler words and applying consistent formatting.</li>
				<li>The note is pasted directly into your EHR or documentation system.</li>
			</ul>
			<p>
				The entire process takes 30 seconds to a minute, compared to 3–5 minutes of typing the
			...
			<p>
				...
				But it's expensive ($99/month for individual licenses), requires a Windows PC or
				specific integrations, and is optimized for large hospital systems.
			</p>
			<p>
