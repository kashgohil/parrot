...
export default function RsiDeveloperVoiceDictation() {
	return (
		<>
			...
			<p>
				Developers don't talk about RSI much. There's an implicit assumption that if you can't
				type, you can't code, and if you can't code, you're not useful. This isn't true, but
				it keeps people quiet about their symptoms until they're severe.
			</p>
			<p>
			...
			<p>
				Voice dictation won't replace typing for writing code. You're not going to dictate a
				React component or a SQL query. But a surprising amount of a developer's day is
			...
			<p>
				For many developers, this non-code text accounts for 30–50% of their daily typing.
				Offloading that to voice dictation meaningfully reduces the strain on your hands.
			</p>

			<h2>A practical setup</h2>
			<p>
				Here's what works for developers managing RSI with <Link to="/">Parrot</Link>:
			</p>
			<ul>
			...
			<p>
				When you dictate a code review comment, you tend to speak casually: "this function
				should probably handle the null case, also the variable name is confusing, maybe rename
				it to something like user settings." The AI cleanup turns that into clean, professional
				text.
			</p>
			<p>
				It also applies your writing style. If you prefer direct, terse feedback in code
				reviews, the cleanup will match that tone. If you write more diplomatically, it
				preserves that too.
			</p>

			<h2>Other things that help</h2>
			<p>
				Voice dictation isn't the only tool for managing RSI. A few other things that
				developers find helpful:
			</p>
			<ul>
			...
			<p>
				You don't have to dictate everything or type everything. The goal is to reduce total
