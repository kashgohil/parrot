...
function OnboardingLayout() {
	...
	return (
		<div className="min-h-screen flex relative">
			...
			<div className="flex-1 flex items-center justify-center bg-background p-6 lg:p-8 xl:p-10 relative overflow-hidden overflow-y-auto">
				<DoodleBackground opacity={0.1} />

				<div className="w-full max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl animate-fade-in-up relative z-10">
